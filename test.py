...
class Model(Prophet):
    ...
    def __init__(self, settings):
        ...
        self.growth=settings["growth"],
        self.seasonality_mode = "multiplicative",
        # 30,
        self.changepoint_prior_scale = self.settings['changepoint_prior_scale'],
        # 35,
        self.seasonality_prior_scale = self.settings['seasonality_prior_scale'],
        self.daily_seasonality = self.settings['daily_seasonality'],
        self.weekly_seasonality = self.settings['weekly_seasonality'],
        self.yearly_seasonality = self.settings['yearly_seasonality'],
